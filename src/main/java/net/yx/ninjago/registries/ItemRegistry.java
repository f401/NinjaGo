...
import net.yx.ninjago.world.item.BommerangItem;
...
public class ItemRegistry {
	...
	public static final RegistryObject<BommerangItem> BOOMERANG  = ITEM_REGISTER.register("boomerang", BommerangItem::new);
}
